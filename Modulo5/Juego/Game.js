...
class Game {
    ...
    constructor () {
        ...
        this.boss = false; // Indica si el jefe final ha muerto o no
    ...
    endGame () {
        ...
        if(this.player.lives > 0 && this.boss === true) {
            let gameOver = new Entity(this, this.width / 2, "auto", this.width / 4, this.height / 4, 0, GAME_WON_PICTURE);
            gameOver.render();
        } else {
